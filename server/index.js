...
const crmIdAuditRouter = require('./api/crmIdAudit');
const crmIdAuditBulkRouter = require('./api/crmIdAuditBulk');
...
const accountTruthRouter = require('./api/accountTruth');
...
app.use('/api/crm-id-audit', crmIdAuditRouter);
app.use('/api/crm-id-audit-bulk', crmIdAuditBulkRouter);
...
app.use('/api/account-truth', accountTruthRouter);
